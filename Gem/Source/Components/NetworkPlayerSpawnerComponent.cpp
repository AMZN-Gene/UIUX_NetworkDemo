...
namespace UIUX_NetworkDemo
{
    ...
    {
        AZ::Interface<UIUX_NetworkDemo::IPlayerSpawner>::Get()->RegisterPlayerSpawner(this);
    }

    void NetworkPlayerSpawnerComponent::OnDeactivate([[maybe_unused]] Multiplayer::EntityIsMigrating entityIsMigrating)
    {
        AZ::Interface<UIUX_NetworkDemo::IPlayerSpawner>::Get()->UnregisterPlayerSpawner(this);
    }
} // namespace UIUX_NetworkDemo